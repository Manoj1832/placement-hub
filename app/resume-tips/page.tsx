  ...
  return (
    <div className="min-h-screen bg-[#2D1A5C] text-white">
      ...
      <main className="container mx-auto px-4 sm:px-6 py-20 flex flex-col items-center justify-center text-center">
        ...
        <h1 className="text-4xl md:text-5xl font-bold mb-4">Resume Tips</h1>
        <p className="text-lg text-white/60 max-w-lg mb-8">
          We are currently working on a comprehensive guide to help you build the perfect ATS-friendly resume. Check back soon!
        </p>
        <Link href="/browse">

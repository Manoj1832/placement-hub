...
import { Eye, EyeOff, UserPlus, Loader2, Check, X, AlertTriangle } from "lucide-react";
...
export default function SignUpPage() {
  ...
  const allValid = passwordChecks.every((c) => c.ok) && name.length >= 2;
    ...
    <div className="flex min-h-screen items-center justify-center bg-[#09090B] px-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-zinc-500 text-sm mt-1">Join PSG Placement Hub</p>
        </div>
        ...
        <div className="bg-zinc-900/60 border border-zinc-800 rounded-2xl p-8 backdrop-blur-sm">
          ...
          {oauthError && (
            <div className="bg-red-500/10 border border-red-500/20 rounded-lg px-4 py-3 text-red-400 text-sm mb-5 flex items-start gap-2">
              ...
              <span>OAuth sign-up failed: {decodeURIComponent(oauthError)}</span>
            </div>
          )}
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-zinc-900/60 px-3 text-zinc-500 uppercase tracking-wider">or create with email</span>
            </div>
          </div>

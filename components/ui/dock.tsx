...
export default function Dock({
  ...
  return (
    <motion.div style={{ height, scrollbarWidth: 'none' }} className={`flex max-w-full items-center ${className}`}>
      <motion.div
        ...
        className={`flex items-end w-fit gap-4 rounded-2xl border-neutral-700 border-2 pb-2 px-4`}
